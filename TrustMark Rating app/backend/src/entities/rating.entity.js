...
var Rating = function () {
    var _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Unique)(['store', 'user'])];
    ...
    var Rating = _classThis = /** @class */ (function () {
        function Rating_1() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.rating = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _rating_initializers, void 0));
            this.comment = (__runInitializers(this, _rating_extraInitializers), __runInitializers(this, _comment_initializers, void 0));
            this.store = (__runInitializers(this, _comment_extraInitializers), __runInitializers(this, _store_initializers, void 0));
            this.user = (__runInitializers(this, _store_extraInitializers), __runInitializers(this, _user_initializers, void 0));
    ...
    (function () {
        ...
        _comment_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _store_decorators = [(0, typeorm_1.ManyToOne)(function () { return store_entity_1.Store; }, function (store) { return store.ratings; })];
        _user_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.ratings; })];

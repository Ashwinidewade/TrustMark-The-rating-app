...
var Store = function () {
    ...
    var Store = _classThis = /** @class */ (function () {
        function Store_1() {
            ...
            this.owner = (__runInitializers(this, _address_extraInitializers), __runInitializers(this, _owner_initializers, void 0));
            this.ratings = (__runInitializers(this, _owner_extraInitializers), __runInitializers(this, _ratings_initializers, void 0));
            this.createdAt = (__runInitializers(this, _ratings_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _address_decorators = [(0, typeorm_1.Column)({ length: 400 })];
        _owner_decorators = [(0, typeorm_1.ManyToOne)(function () { return user_entity_1.User; }, function (user) { return user.stores; })];
        _ratings_decorators = [(0, typeorm_1.OneToMany)(function () { return rating_entity_1.Rating; }, function (rating) { return rating.store; })];

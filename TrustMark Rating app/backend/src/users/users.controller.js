...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.findAll = function (name_1, email_1, address_1, role_1) {
            return __awaiter(this, arguments, void 0, function (name, email, address, role, page, limit, sortBy, sortOrder) {
                if (page === void 0) { page = 1; }
                if (limit === void 0) { limit = 10; }
                if (sortBy === void 0) { sortBy = 'name'; }
                if (sortOrder === void 0) { sortOrder = 'ASC'; }
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.findAll({ name: name, email: email, address: address, role: role }, page, limit, sortBy, sortOrder)];
                });
            });
        };
        UsersController_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.getStats()];
                });
            });
        };
    ...
    (function () {
        ...
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN)];

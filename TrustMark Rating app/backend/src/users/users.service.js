...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.findAll = function (filters_1) {
            return __awaiter(this, arguments, void 0, function (filters, page, limit, sortBy, sortOrder) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            _a = _c.sent(), users = _a[0], total = _a[1];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a.password = _b.sent();
                            _b.label = 2;
                        case 2: return [4 /*yield*/, this.usersRepository.update(id, userData)];
                        case 3:
                            _b.sent();
        ...
        UsersService_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                var totalUsers, totalAdmins, totalStoreOwners, totalNormalUsers;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersRepository.count()];
                        case 1:
                            totalUsers = _a.sent();
                            return [4 /*yield*/, this.usersRepository.count({ where: { role: user_entity_1.UserRole.ADMIN } })];
                        case 2:
                            totalAdmins = _a.sent();
                            return [4 /*yield*/, this.usersRepository.count({ where: { role: user_entity_1.UserRole.STORE_OWNER } })];
                        case 3:
                            totalStoreOwners = _a.sent();
                            return [4 /*yield*/, this.usersRepository.count({ where: { role: user_entity_1.UserRole.USER } })];
                        case 4:
                            totalNormalUsers = _a.sent();
                            return [2 /*return*/, {
